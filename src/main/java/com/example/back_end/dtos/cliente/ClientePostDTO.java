...
@Schema(name = "ClientePostDTO", description = "Dados para criação de um novo cliente")
@Getter
@Setter
@AllArgsConstructor
@NoArgsConstructor
public class ClientePostDTO {
    ...
    @Schema(description = "E-mail do cliente", example = "admin@teste.com")
    @NotBlank(message = "O email é um campo obrigatório.")
    @Size(max = 50, message = "O email não pode exceder {max} caracteres.")
